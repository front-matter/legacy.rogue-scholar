  ...
  [
    {
      ...
      answer: 'The Rogue Scholar is available with limited functionality since April 1, 2023.',
    },
    {
      question: 'When will the full functionality of the Rogue Scholar become available?',
      answer:
    ...
    },
    {
      ...
      answer: 'Yes. We accept blogs about all forms of scholarship. The term “science” is used in the broadest sense.',
    },
  ],
  [
    {
    ...
    },
    {
      ...
      answer: 'We support feeds using RSS, Atom or JSON Feed. Contact us for support of custom extensions.',
    },
    {
      question: 'My RSS feed only contains summaries of blog posts.',
      answer: 'You need to provide all content via RSS feed, but this can also be a private feed.',
    },
    {
  ...
  [
    {
      ...
      answer: 'The Rogue Scholar is free for the first 50 posts per year. After that, it costs $1 per post.',
    },
    {
...
export default function Faqs() {
  ...
  return (
    <section id="faq" aria-labelledby="faq-title" className="relative overflow-hidden py-10 sm:py-16">
            ...
            <li key={columnIndex}>
              <ul role="list" className="flex flex-col gap-y-8">
                {column.map((faq, faqIndex) => (
                  <li key={faqIndex}>
                    <h3 className="font-display text-lg font-semibold leading-7 text-slate-900">{faq.question}</h3>
                    <p className="mt-0 text-base text-slate-700">{faq.answer}</p>
                  </li>
                ))}
              </ul>
            </li>
