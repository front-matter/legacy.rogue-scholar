...
export const blogsSelect =
  "id, title, description, language, favicon, feed_url, current_feed_url, feed_format, home_page_url, mastodon, created_at, modified_at, license, generator, category, backlog, prefix, status, plan"
export const blogWithPostsSelect =
  "id, title, description, language, favicon, feed_url, current_feed_url, feed_format, home_page_url, mastodon, created_at, modified_at, license, generator, category, backlog, prefix, status, plan, items: posts (id, doi, url, title, summary, published_at, updated_at, indexed_at, authors, image, tags, language, reference)"
