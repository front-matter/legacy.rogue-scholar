...
These guidelines are recommendations for authors of scholarly blogs top help with long-term archiving, discoverability, and citation of the blog content.
They are modelled after the publication [A Data Citation Roadmap for Scholarly Data Repositories](https://doi.org/10.1038/s41597-019-0031-8),
where many of the same guidelines apply, and where the first author is also involved in the Rogue Scholar.
