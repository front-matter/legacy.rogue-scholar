  ...
  return (
    <Container className="pt-10 pb-16 text-center lg:pt-16">
      ...
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
        The Rogue Scholar improves your science blog in important ways,< br /> 
      ...
      <div className="mt-36 lg:mt-44">
        <p className="font-display text-base text-slate-900">
          These blogs so far have been approved on the waitlist
        </p>
        <ul
          role="list"
        ...
        >
          {[
            [
              { name: 'Front Matter', logo: logoFrontMatter }
            ],
